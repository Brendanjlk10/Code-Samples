...
try:
    connection = pymysql.connect(host='localhost', user='root', password='Bj&5426256277', db='book_fetch_inc', charset = 'utf8')#Connection to the database
    ...
    def createBookModule(administratorID):
        try:
            with connection.cursor() as cursor:
                ...
                createBookWindow.configure(width = 250)
                createBookWindow.configure(height = 600)
                ...
                newISBN13Frame = Frame(createBookWindow, bg = "blue")
                newISBN13Label = Label(newISBN13Frame, text = "Book's ISBN13:")
                newISBN13Label.pack(side = LEFT)
                newISBN13Entry = Entry(newISBN13Frame, bd = 1, width = 15)
                newISBN13Entry.pack(side = RIGHT)
                newISBN13Frame.pack()
                
                newPurchaseTypeFrame = Frame(createBookWindow, bg = "blue")
                newPurchaseTypeLabel = Label(newPurchaseTypeFrame, text = "Purchase Type")
                newPurchaseTypeLabel.pack(side = LEFT)
                newPurchaseTypeRadioFrame = Frame(newPurchaseTypeFrame, bg = "blue")
                newPurchaseTypeRadioVar = IntVar(createBookWindow)
                rentRadio = Radiobutton(newPurchaseTypeRadioFrame, text="Rent", variable=newPurchaseTypeRadioVar, value=1)
                rentRadio.pack()
                buyRadio = Radiobutton(newPurchaseTypeRadioFrame, text="Buy", variable=newPurchaseTypeRadioVar, value=2)
                buyRadio.pack()
                newPurchaseTypeRadioFrame.pack(side = RIGHT)
                newPurchaseTypeFrame.pack()
                
                newConditionFrame = Frame(createBookWindow, bg = "blue")
                newConditionLabel = Label(newConditionFrame, text = "Condition")
                newConditionLabel.pack(side = LEFT)
                newConditionRadioFrame = Frame(newConditionFrame, bg = "blue")
                newConditionRadioVar = IntVar(createBookWindow)
                newRadio = Radiobutton(newConditionRadioFrame, text="New", variable=newConditionRadioVar, value=1)
                newRadio.pack()
                usedRadio = Radiobutton(newConditionRadioFrame, text="Used", variable=newConditionRadioVar, value=2)
                usedRadio.pack()
                newConditionRadioFrame.pack(side = RIGHT)
                newConditionFrame.pack()
                
                newFormatFrame = Frame(createBookWindow, bg = "blue")
                newFormatLabel = Label(newFormatFrame, text = "Format")
                newFormatLabel.pack(side = LEFT)
                newFormatRadioFrame = Frame(newFormatFrame, bg = "blue")
                newFormatRadioVar = IntVar(createBookWindow)
                hardcoverRadio = Radiobutton(newFormatRadioFrame, text="Hard Cover", variable=newFormatRadioVar, value=1)
                hardcoverRadio.pack()
                paperbackRadio = Radiobutton(newFormatRadioFrame, text="Paperback", variable=newFormatRadioVar, value=2)
                paperbackRadio.pack()
                electronicRadio = Radiobutton(newFormatRadioFrame, text="Electronic", variable=newFormatRadioVar, value=3)
                electronicRadio.pack()
                newFormatRadioFrame.pack(side = RIGHT)
                newFormatFrame.pack()
                
                newPriceFrame = Frame(createBookWindow, bg = "blue")
                newPriceLabel = Label(newPriceFrame, text = "Book's Price: ")
                newPriceLabel.pack(side = LEFT)
                newPriceEntry = Entry(newPriceFrame, bd = 1, width = 15)
                newPriceEntry.pack(side = RIGHT)
                newPriceFrame.pack()
                
                newTitleFrame = Frame(createBookWindow, bg = "blue")
                newTitleLabel = Label(newTitleFrame, text = "Book's Title: ")
                newTitleLabel.pack(side = LEFT)
                newTitleEntry = Entry(newTitleFrame, bd = 1, width = 15)
                newTitleEntry.pack(side = RIGHT)
                newTitleFrame.pack()
                
                newQuantityFrame = Frame(createBookWindow, bg = "blue")
                newQuantityLabel = Label(newQuantityFrame, text = "Quantity: ")
                newQuantityLabel.pack(side = LEFT)
                newQuantitySpinBox = Spinbox(newQuantityFrame, from_ = 0, to = 32767)
                newQuantitySpinBox.pack(side = RIGHT)
                newQuantityFrame.pack()
                
                newLanguageFrame = Frame(createBookWindow, bg = "blue")
                newLanguageLabel = Label(newLanguageFrame, text = "Language: ")
                newLanguageLabel.pack(side = LEFT)
                newLanguageEntry = Entry(newLanguageFrame, bd = 1, width = 15)
                newLanguageEntry.pack(side = RIGHT)
                newLanguageFrame.pack()
                
                newPublishYearFrame = Frame(createBookWindow, bg = "blue")
                newPublishYearLabel = Label(newPublishYearFrame, text = "Publish Year: ")
                newPublishYearLabel.pack(side = LEFT)
                newPublishYearEntry = Entry(newPublishYearFrame, bd = 1, width = 15)
                newPublishYearEntry.pack(side = RIGHT)
                newPublishYearFrame.pack()
                
                newPublisherFrame = Frame(createBookWindow, bg = "blue")
                newPublisherLabel = Label(newPublisherFrame, text = "Publisher: ")
                newPublisherLabel.pack(side = LEFT)
                newPublisherEntry = Entry(newPublisherFrame, bd = 1, width = 15)
                newPublisherEntry.pack(side = RIGHT)
                newPublisherFrame.pack()
                
                newEditionFrame = Frame(createBookWindow, bg = "blue")
                newEditionLabel = Label(newEditionFrame, text = "Edition: ")
                newEditionLabel.pack(side = LEFT)
                newEditionSpinBox = Spinbox(newEditionFrame, from_ = 0, to = 32767)
                newEditionSpinBox.pack(side = RIGHT)
                newEditionFrame.pack()
                
                newWeightFrame = Frame(createBookWindow, bg = "blue")
                newWeightLabel = Label(newWeightFrame, text = "Weight: ")
                newWeightLabel.pack(side = LEFT)
                newWeightSpinBox = Spinbox(newWeightFrame, from_ = 0, to = 32767)
                newWeightSpinBox.pack(side = RIGHT)
                newWeightFrame.pack()
                
                newCategoryFrame = Frame(createBookWindow, bg = "blue")
                newCategoryLabel = Label(newCategoryFrame, text = "Category: ")
                newCategoryLabel.pack(side = LEFT)
                newCategoryEntry = Entry(newCategoryFrame, bd = 1, width = 15)
                newCategoryEntry.pack(side = RIGHT)
                newCategoryFrame.pack()
                
                newAuthorFrame = Frame(createBookWindow, bg = "blue")
                newAuthorLabel = Label(newAuthorFrame, text = "Author: ")
                newAuthorLabel.pack(side = LEFT)
                newAuthorEntry = Entry(newAuthorFrame, bd = 1, width = 15)
                newAuthorEntry.pack(side = RIGHT)
                newAuthorFrame.pack()
                
                newKeywordFrame = Frame(createBookWindow, bg = "blue")
                newKeywordLabel = Label(newKeywordFrame, text = "Keyword: ")
                newKeywordLabel.pack(side = LEFT)
                newKeywordEntry = Entry(newKeywordFrame, bd = 1, width = 15)
                newKeywordEntry.pack(side = RIGHT)
                newKeywordFrame.pack()
                
                newSubcategoryFrame = Frame(createBookWindow, bg = "blue")
                newSubcategoryLabel = Label(newSubcategoryFrame, text = "Subcategory: ")
                newSubcategoryLabel.pack(side = LEFT)
                newSubcategoryEntry = Entry(newSubcategoryFrame, bd = 1, width = 15)
                newSubcategoryEntry.pack(side = RIGHT)
                newSubcategoryFrame.pack()
                
                def createTheBook():
                    createBookWindow.quit()
                    createBookWindow.destroy()
                    
                chooseBooksButton = Button(createBookWindow, text="Create the book", command = createTheBook)
                chooseBooksButton.pack(side = BOTTOM)
                
                createBookWindow.mainloop()
    ...
    def initialAdministratorModule(administratorID):
        try:
            ...
            initialAdministratorWindow.configure(width = 450)
            ...
            def administratorWhatDoSelection():
                if administratorDoRadioVar.get() == 1:#Create book with inventory
                    createBookModule(administratorID)
